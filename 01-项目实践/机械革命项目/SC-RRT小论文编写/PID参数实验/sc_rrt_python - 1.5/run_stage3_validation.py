...
def run_stage3_validation(kp, ki, kd, pareto_interval=4, num_runs=30):
    """
    ...
    num_runs : int
        Number of validation runs (default: 30 for statistical significance)
    ...
    env = EnvironmentConfig.generate_3d_environment(
        ...
        num_obstacles=400,
        start_point=np.array([100, 100, 100]), 
        goal_point=np.array([1400, 1400, 1400]),
