...
function runAlgorithmComparison(varargin)
    ...
    if isempty(p.Results.Algorithms)
        algorithms = {'RRT_Basic', 'RRT_Connect_Basic', 'RRT_Star_Basic', 'SC_RRT_Basic', 'Dynamic_RRT_Basic'};
    else
                ...
                try
                    ...
                    if success
                        ...
                        if visualize && run == 1  % \u53ea\u53ef\u89c6\u5316\u7b2c\u4e00\u6b21\u8fd0\u884c
                            visualizeAndSaveRRTResult(env, path, tree, success, algo_name, 'results', metrics);
                        end
                    else
                        fprintf('  ✗ 失败\n');
                    end
