function visualizeAndSaveRRTResult(env, path, tree, success, algorithm_name, save_dir)
...
if is_2d
    ...
    % 标题包含统计信息
    title(sprintf('%s 路径规划结果 (2D)\n路径长度: %.2f m | 搜索节点: %d | 路径节点: %d', ...
          algorithm_name, path_length, num_nodes, num_path_nodes), ...
          'FontSize', 14, 'FontWeight', 'bold');
    
    legend('障碍物', '搜索树', '规划路径', '路径节点', '起点', '终点', ...
