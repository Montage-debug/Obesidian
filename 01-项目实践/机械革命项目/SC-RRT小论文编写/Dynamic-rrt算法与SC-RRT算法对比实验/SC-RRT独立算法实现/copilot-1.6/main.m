...
configParams = struct(...
    ...
    'dual_ellipsoid_update_interval', 1, ...    % 椭球体更新间隔(1=每次迭代更新)
    ...
    'visualization_interval', 5, ...            % 可视化更新间隔(增大减少普通节点绘制)
...
env_configs = {
    ...
    struct('dimension','3D','bounds',[0 1500 0 1500 0 1500],...
           'startPoint',[200 200 200],'goalPoint',[1300 1300 1300],...
           'numObstacles',400,'obstacleRadius',50,'seed',123,...
           'description','3D Fixed Obstacles'),
    
    % Environment 4: 3D with random obstacles (varies each run)
    struct('dimension','3D','bounds',[0 1500 0 1500 0 1500],...
           'startPoint',[200 200 200],'goalPoint',[1300 1300 1300],...
           'numObstacles',400,'obstacleRadius',50,'seed',NaN,...
