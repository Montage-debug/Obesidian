...
/******************************************************************************/
uint32_t getRawCount(uint8_t x);
/******************************************************************************/
...
void MagneticSensor_Init(void)
{
  ...
  SPI3_Init_(0,SPI_CPOL_Low);    //MT6701
	...
	printf("M0_MT6701\r\n");
#elif M0_MT6835
  SPI3_Init_(0,SPI_CPOL_High);    //MT6835
	M0.cpr = MT6835_CPR;
	printf("M0_MT6835\r\n");
#elif M0_ABZ
  ...
  SPI3_Init_(1,SPI_CPOL_Low);    //MT6701
	...
	printf("M1_MT6701\r\n");
#elif M1_MT6835
  SPI3_Init_(1,SPI_CPOL_High);    //MT6835
	M1.cpr = MT6835_CPR;
	printf("M1_MT6835\r\n");
#elif M1_ABZ
...
/******************************************************************************/
uint32_t getRawCount(uint8_t x)  //获取编码器的原始值
{
	uint32_t val;
